...
var TemplateError, cache, coffee, coffeecup, coffeescript_helpers, compiler, elements, express3engine, fs, merge_elements, pathCache, skeleton,
  __slice = [].slice,
...
if (typeof window === "undefined" || window === null) {
  ...
  express3engine = function(path, data, cb) {
    var renderfn, txt, _ref;
    if (!pathCache[path] || !data.cache) {
    ...
    return cb(null, pathCache[path](data));
  };
